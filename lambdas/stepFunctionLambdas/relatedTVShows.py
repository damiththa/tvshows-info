    ...
    if similarTVShows['total_results'] != 0 :  # making sure there is a valid return
        ...
        if len(similarShows_lst) != 0:
            ...
            if res.status_code == 200:
                print (f'Woot Woot - {len(similarShows_lst)} shows successfully added to related TV shows table.')
            
        else:
            print (f'Sorry evernthough there are similar shows but none of them made the {cutoff_years} cuttoff years.')
